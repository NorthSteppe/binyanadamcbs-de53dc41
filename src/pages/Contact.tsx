...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Seo
        title="Contact Blueprint — Get in Touch"
        description="Reach out to Blueprint about therapy, supervision, family or school support. We respond to enquiries from Manchester and across the UK."
        path="/contact"
      />
      <Header />


      <section className="pb-24" style={{ paddingTop: "var(--header-height)" }}>
