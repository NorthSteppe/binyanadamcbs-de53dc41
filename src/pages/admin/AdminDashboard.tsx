...
const categories = [
  ...
  },
  {
    ...
    tools: [
      ...
      { label: "Pathway Quiz", path: "/admin/pathway-quiz", icon: Sparkles, description: "Edit the 'Let's Explore Together' welcome slides that route visitors to the right pages" },
