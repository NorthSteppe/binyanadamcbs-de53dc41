...
export const translations = {
  en: {
    ...
    superviseeHub: {
      ...
      portalFooter: "Supervisee Portal · Binyan Adam CBS",
    ...
    staffHub: {
      ...
      portalFooter: "Therapist Portal · Binyan Adam CBS",
    },
  ...
  he: {
    ...
    services: {
      ...
      cards: {
        ...
        supervision: { title: "סופרוויז׳ן", description: "פיתוח מטפלים חושבים ואתיים. סופרוויז׳ן UKBA, חונכות ופרקטיקה רפלקטיבית." },
      },
